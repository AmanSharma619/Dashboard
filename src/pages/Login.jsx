        ...
        <div className='w-screen h-screen flex bg-gray-200 items-center justify-center'>
            <div className="container h-[90%] w-[90%] bg-white rounded-4xl flex p-2 border-0 border-fuchsia-500">
                <div className="left w-1/2 flex flex-col justify-center items-center">
                    <div className="left-subdiv w-[85%] h-[85%]  flex flex-col justify-evenly">
                        <div>
                        ...
                        <div className='w-full h-[70%] flex flex-col justify-between '>
                            ...
                            <div className='text-gray-700 flex gap-1'>
                              ...
                              <h2 className="font-bold bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text text-transparent">Sign Up</h2>
